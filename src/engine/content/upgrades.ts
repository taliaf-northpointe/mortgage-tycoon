/**
 * The 35-upgrade tree (GDD §7): 5 categories × 7 tiers. Data only.
 * Effect rates live in constants.ts; benefit chips describe them.
 * Tiers 6–7 arrived 2026-07-08 with Talia's Office 4 art.
 */
...
export const UPGRADES: UpgradeDef[] = [
  ...
  { id: 'gardenAtrium', category: 'office', tier: 6, name: 'Garden Atrium', flavor: 'A tiny forest between the desks.', cost: 18_000, benefits: ['+ daily team morale'] },
  { id: 'skylineSuite', category: 'office', tier: 7, name: 'Skyline Suite', flavor: 'Floor-to-ceiling windows, city lights, your name on the door.', cost: 30_000, benefits: ['+ daily team morale'] },
  ...
  { id: 'mentorProgram', category: 'training', tier: 6, name: 'Mentor Program', flavor: 'Your seniors grow the next seniors.', cost: 12_000, benefits: ['+20% training gains', '+0.1 skill cap'] },
  { id: 'industryConference', category: 'training', tier: 7, name: 'Industry Conference', flavor: 'Send the whole team; they come back unstoppable.', cost: 20_000, benefits: ['+20% training gains', '+0.1 skill cap'] },
  ...
  { id: 'skylineBillboard', category: 'marketing', tier: 6, name: 'Skyline Billboard', flavor: 'Your smile, forty feet wide.', cost: 16_000, benefits: ['+5% new leads', '+2 reputation'] },
  { id: 'hometownSponsor', category: 'marketing', tier: 7, name: 'Hometown Sponsor', flavor: 'The little-league jerseys wear your logo.', cost: 26_000, benefits: ['+5% new leads', '+2 reputation'] },
  ...
  { id: 'digitalClosings', category: 'technology', tier: 6, name: 'Digital Closings', flavor: 'Sign anywhere — even the porch.', cost: 21_000, benefits: ['+5% processing speed'] },
  { id: 'smartPipeline', category: 'technology', tier: 7, name: 'Smart Pipeline', flavor: 'The files practically route themselves.', cost: 32_000, benefits: ['+5% processing speed'] },
  ...
  { id: 'homewarmingCrew', category: 'customerExperience', tier: 6, name: 'Homewarming Crew', flavor: 'You bring the boxes in, too.', cost: 17_000, benefits: ['+ trust from Contact', '+ happiness on milestones'] },
  { id: 'anniversaryClub', category: 'customerExperience', tier: 7, name: 'Anniversary Club', flavor: 'A card every year the keys turn.', cost: 25_000, benefits: ['+ trust from Contact'] },
];
